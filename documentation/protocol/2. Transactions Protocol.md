...
> **Deprecation Notice** <br> <br> Deferred transactions are deprecated as of EOSIO 2.0. For more details on their behavior, refer to the [Deferred Transactions]() section on the `eosio.cdt` documentation.
