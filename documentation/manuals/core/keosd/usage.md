# Keosd Usage
> Recommended Usage <br> <br> For most users, the easiest way to use `keosd` is to have cleos launch it automatically. Wallet files will be created in the default directory (~/eosio-wallet).
