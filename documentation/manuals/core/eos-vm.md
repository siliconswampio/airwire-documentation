...
__EOS-VM__ utilizes __CMake__ which allows integration into a project to be as little as adding `ala-vm` to the list of targets in the `target_link_libraries`.
